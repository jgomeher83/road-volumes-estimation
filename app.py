...
st.markdown('')
st.markdown("<h4 style='text-align: justify; color: gray;'>YOLOv8 is an object detection neural network that uses a deep learning architecture to detect and classify objects in an image or video. In the context of vehicular traffic counting, YOLOv8 can be used to detect vehicles in a road video and then count the number of vehicles that have passed.</h4>", unsafe_allow_html=True)
st.markdown('')
